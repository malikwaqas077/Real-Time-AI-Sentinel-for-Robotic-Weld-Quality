...
struct AuthenticationRequest_
{
  ...
  _mac_type mac;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _client_type;
  _client_type client;
  ...
  _dest_type dest;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _rand_type;
  _rand_type rand;
...
struct Printer< ::rosauth::AuthenticationRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosauth::AuthenticationRequest_<ContainerAllocator>& v)
  {
    ...
    s << indent << "client: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.client);
    s << indent << "dest: ";
    ...
    s << indent << "rand: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.rand);
    s << indent << "t: ";
